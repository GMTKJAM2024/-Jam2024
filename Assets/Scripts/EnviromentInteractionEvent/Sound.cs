...
namespace DynamicAudio
{
    ...
    {
        public SoundEventProperty soundEvent;
        public ParitcleScriptableObject ParicleEvent;
        public EventScriptableObject eventScriptable;
    }
    ...
    {
        public EventReference soundProperty;
        public EventInstance soundInstance;
        [Range(0, 1)] public float VolumneRange;
    }
